...
namespace cli {
  ...
  class Command {
    public:
      ...
      /**
       * \fn shared_ptr<Command> option(const std::string&*, const std::string&* = "")
       ...
       */
      std::shared_ptr<Command> option(const std::string&, const std::string& = "");

      /**
       * \fn shared_ptr<Command> command(const std::string&*)
       ...
       */
      bool handle_has_name(const const std::string&, const std::string&) const;
